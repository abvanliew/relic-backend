...
podman exec mongo-db bash -c 'mongoexport -d relic -c skills -o /data/backup/skills.jsonl'
...
podman exec mongo-db bash -c 'mongoimport --db=relic --collection=skills --file=/data/backup/skills.jsonl --mode upsert'
